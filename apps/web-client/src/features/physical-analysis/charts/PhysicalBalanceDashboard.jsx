...
export default function PhysicalBalanceDashboard({ daily }) {
    ...
    return (
        <ChartShell
            ...
            insight={insight}
            info={{
                what: 'A composite 0–100 score combining how well steps, sleep, and energy each fall in their healthy bands.',
                how:  'Each metric is scored 0–100 against its ideal range, then averaged. 80+ is excellent; below 45 needs attention.',
                why:  'Single-number summary you can track day to day. Going up = your three habits are getting more aligned with healthy bands.',
            }}
        >
