...
export default function DailyActivityTrend({ daily }) {
    ...
    return (
        <ChartShell
            ...
            insight={insight}
            info={{
                what: 'Two-line chart of your daily step count (teal) and active calorie burn (amber) over time.',
                how:  'Both lines usually move together. Look for sustained climbs (improving) vs sustained drops (declining). Peak/low markers call out your extreme days.',
                why:  'Spotting trends matters more than any single day. A two-week downward drift is a stronger signal than one quiet weekend.',
            }}
        >
            <Plot
                data={data}
