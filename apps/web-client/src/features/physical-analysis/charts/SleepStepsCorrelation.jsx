...
export default function SleepStepsCorrelation({ daily }) {
    ...
    return (
        <ChartShell
            ...
            insight={insight}
            info={{
                what: 'Each dot pairs one night\'s sleep with the NEXT day\'s steps. The dashed trend line shows the best-fit relationship.',
                how:  'Upward-sloping trend = sleeping more leads to more activity (the healthy pattern). Flat = no relationship. r near 0 means sleep doesn\'t predict your activity.',
                why:  'Tests the "good sleep → productive day" theory specifically for you. Some people are deeply affected by sleep; others aren\'t.',
            }}
        >
